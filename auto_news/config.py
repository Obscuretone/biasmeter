...
DEFAULT_DB_PATH = os.getenv("DOCUMENT_DB_PATH", "data/auto_news.sqlite")
...
MISTRAL_RETRY_BASE_SECONDS = float(os.getenv("MISTRAL_RETRY_BASE_SECONDS", "5"))
MISTRAL_RETRY_MAX_SLEEP_SECONDS = float(
    os.getenv("MISTRAL_RETRY_MAX_SLEEP_SECONDS", "120")
)
